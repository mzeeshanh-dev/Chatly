...
import { Check, Checks, CheckCircle, FileText, DownloadSimple, Play, Pause, Microphone } from "@phosphor-icons/react";
    ...
    >
      ...
      >
        ...
        {mediaType === "image" && mediaUrl ? (
          ...
          <img src={mediaUrl} alt="attachment" className={clsx("rounded-xl max-w-[240px] max-h-[240px] object-cover", text && "mb-1.5")} />
